...
const LinkBox: React.FC<LinkBoxProps> = ({ width = "51", height = "34", text, docTitle=""}) => {
  ...
  return (
    text=="역링크"?
    <svg xmlns="http://www.w3.org/2000/svg" width="61" height="34" viewBox="0 0 61 34" fill="none" onClick={handleClick}>
    ...
    :
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 51 34" fill="none" onClick={handleClick}>
